...
using DepartmentEmployees.Web.Repositories;
...
namespace DepartmentEmployees.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string mySqlConnectionStr = Configuration.GetConnectionString("MariaDbConnection");
            ...
            services.AddScoped<DbContext, MariaDbContext>();
